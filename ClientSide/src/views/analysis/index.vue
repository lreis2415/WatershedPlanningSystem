        ...
        <div v-if="showPareto">
          <Row :gutter="16" class="mb20">
            ...
            <Card>
              ...
              <img class="legendParetoFronts" src="@/assets/img/legendParetoFronts.jpg" />
            </Card>
            </Col>
          </Row>
        </div>
          ...
          <Row :gutter="16" class="mb20">
            ...
            <Card class="chart-wrap">
              ...
              <div style="position: relative">
                ...
                <img class="legend" src="@/assets/img/legendStepwise.jpeg" />
              </div>
            </Card></div>
            </Col>
            <Col span="12">
...
export default {
  ...
  methods: {
    ...
    getUnitToGeneIndx() {
      const root = this
      axios.get('/api/unit_to_gene.json').then(function (response) {
        root.unit_to_gene_indx = response.data
      })
      axios.get('/api/unit_to_gene_30.json').then(function (response) {
